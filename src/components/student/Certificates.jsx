    ...
    <div className={`inner-screen lk-inner${open?" open":""}`}>
      ...
      <div className="inner-body">
        ...
        <div className="section-card" >
          ...
          <div style={{fontSize:"0.8125rem",color:"#7B9DBF",padding:"6px 0"}}>Справка об обучении — выдана 10 апреля 2026</div>
          <div style={{fontSize:"0.8125rem",color:"#7B9DBF",padding:"6px 0"}}>Академическая справка — выдана 3 марта 2026</div>
        </div>
      </div>
    </div>
  );
